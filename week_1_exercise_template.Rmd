...
cel<-cel%>%mutate(Gender=recode(female, '0'="Male", '1'="Female"))
cel%>%ggplot(aes(x=dwnom1,y=all_pass,color=Gender))+geom_point()+labs(x="Member Ideology", y="Bills Passed", title="Scatter Plot of the Bills Passed vs. Ideology")
```
...
####PUT YOUR CODE HERE
cel$majority<-recode(cel$majority,'0'="Not in Majority",'1'="Majority")
cel%>%ggplot(aes(votepct,all_pass,color=Gender))+geom_point()+facet_wrap(.~majority)+scale_color_manual(values=c("Male"="green", "Female"="orange"))+labs(x="Vote Percentage", y="Bills Passed", title="No. of Bills Passed by Majority")
...
####PUT YOUR CODE HERE
cel%>%ggplot(aes(x=majority, y=les))+geom_boxplot()+labs(x="Majority or Minority",y="Legislative Effective Score", title="LES in 115th Congress")
```
