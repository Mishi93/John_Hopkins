...
my_dat%>%ggplot(aes(x=Category, y=Value, fill=City))+geom_bar(stat="Identity")+transition_states(City)
...
ggplotly(my_dat%>%ggplot(aes(x=Company, y= Output))+geom_boxplot(aes(fill=Company)))
